...
<section class="section">
    <div class="container">
        ...
        <div class="program-grid reveal">
            <div class="program-item"><div class="program-icon"><i class="fas fa-heart"></i></div><div class="program-title">Penghayatan dan Pengamalan Pancasila</div></div>
            <div class="program-item"><div class="program-icon"><i class="fas fa-hands-holding-circle"></i></div><div class="program-title">Gotong Royong</div></div>
            <div class="program-item"><div class="program-icon"><i class="fas fa-utensils"></i></div><div class="program-title">Pangan</div></div>
            <div class="program-item"><div class="program-icon"><i class="fas fa-shirt"></i></div><div class="program-title">Sandang</div></div>
            <div class="program-item"><div class="program-icon"><i class="fas fa-house-chimney"></i></div><div class="program-title">Perumahan dan Tata Laksana Rumah Tangga</div></div>
            <div class="program-item"><div class="program-icon"><i class="fas fa-graduation-cap"></i></div><div class="program-title">Pendidikan dan Keterampilan</div></div>
            <div class="program-item"><div class="program-icon"><i class="fas fa-heart-pulse"></i></div><div class="program-title">Kesehatan</div></div>
            <div class="program-item"><div class="program-icon"><i class="fas fa-shop"></i></div><div class="program-title">Pengembangan Kehidupan Berkoperasi</div></div>
            <div class="program-item"><div class="program-icon"><i class="fas fa-leaf"></i></div><div class="program-title">Kelestarian Lingkungan Hidup</div></div>
            <div class="program-item"><div class="program-icon"><i class="fas fa-calendar-check"></i></div><div class="program-title">Perencanaan Sehat</div></div>
        </div>
        ...
        <div style="margin-top: 5rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem;" class="reveal">
            <div style="background:var(--gray-50); padding:2rem; border-radius:16px; border-left:4px solid var(--primary);">
                ...
                <p style="font-size:0.95rem; color:var(--text-secondary); line-height:1.7;"><?= e($S['pkk_sasaran'] ?? '') ?></p>
                <ul style="margin-top:10px; font-size:0.9rem; color:var(--text-secondary); display:flex; flex-direction:column; gap:8px;">
                    <li><i class="fas fa-check-circle" style="color:var(--primary);"></i> <strong>Mental Spiritual:</strong> <?= e($S['pkk_sasaran_mental'] ?? '') ?></li>
                    <li><i class="fas fa-check-circle" style="color:var(--primary);"></i> <strong>Fisik Material:</strong> <?= e($S['pkk_sasaran_fisik'] ?? '') ?></li>
                </ul>
            </div>
            <div style="background:var(--gray-50); padding:2rem; border-radius:16px; border-left:4px solid var(--accent-light);">
                ...
                <p style="font-size:0.95rem; color:var(--text-secondary); line-height:1.7;"><?= e($S['pkk_tugas'] ?? '') ?></p>
                <div style="margin-top:15px;"><a href="profil.php" class="btn btn-outline btn-sm" style="background:#fff;">Lihat Detail Fungsi <i class="fas fa-arrow-right"></i></a></div>
            </div>
        </div>
    </div>
</section>
...
<section class="section">
    <div class="container">
        ...
        <?php if (empty($beritaList)): ?>
            <div class="empty-state"><i class="fas fa-newspaper"></i><h3>Belum Ada Berita</h3><p>Berita akan segera ditambahkan oleh admin.</p></div>
        <?php else: ?>
            <div class="berita-featured reveal">
                ...
                <div class="berita-main-card">
                    ...
                    <div class="berita-main-overlay">
                        ...
                        <h2 class="berita-main-title"><a href="berita-detail.php?id=<?= $bUtama['id'] ?>"><?= e($bUtama['judul']) ?></a></h2>
                        <div class="berita-main-meta"><span><i class="fas fa-calendar"></i> <?= formatTanggal($bUtama['tgl_post']) ?></span><span><i class="fas fa-user"></i> Admin</span></div>
                    </div>
                </div>
                ...
                <div class="berita-side">
                    <?php for ($i = 1; $i < count($beritaList); $i++): $b = $beritaList[$i]; ?>
                        <div class="berita-side-item">
                            <div class="berita-side-img"><img src="<?= getImg($b['gambar'], 'berita') ?>" alt="<?= e($b['judul']) ?>"></div>
                            <div class="berita-side-body">
                                <div class="berita-side-cat"><?= e($b['kategori'] ?? 'Berita') ?></div>
                                <div class="berita-side-title"><a href="berita-detail.php?id=<?= $b['id'] ?>"><?= e($b['judul']) ?></a></div>
            ...
            <div class="section-footer"><a href="berita.php" class="btn btn-secondary"><i class="fas fa-arrow-right"></i> Lihat Semua Berita</a></div>
        <?php endif; ?>
    </div>
</section>
...
<section class="section section-alt">
    <div class="container">
        ...
        <?php if (empty($kegiatanList)): ?>
            <div class="empty-state"><i class="fas fa-calendar-times"></i><h3>Belum Ada Kegiatan</h3><p>Data kegiatan akan segera ditambahkan.</p></div>
        <?php else: ?>
            <div class="galeri-grid">
                <?php foreach ($kegiatanList as $k): ?>
                    <div class="galeri-item reveal" data-src="<?= getImg($k['gambar'], 'kegiatan') ?>" data-caption="<?= e($k['judul']) ?>">
            ...
            <div class="section-footer"><a href="kegiatan.php" class="btn btn-secondary"><i class="fas fa-arrow-right"></i> Lihat Semua Kegiatan</a></div>
        <?php endif; ?>
    </div>
</section>
